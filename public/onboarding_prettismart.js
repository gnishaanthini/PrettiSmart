(function() {
    ...
    {
        "step_id": "step_1",
        "text": "This visualization helps you see how contract functions move cryptocurrency and change state across simulated calls. It combines an overview selector, function summaries, a call-by-call flow view, and a state timeline.",
        "step_type": "structure",
        "targets": {
    ...
    {
        "step_id": "step_2",
        "text": "Start in the small-multiple overview to pick a simulation, then read flows and balances in the center timeline and inspect variable changes at the bottom.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "simulation_overview",
            "resolvedSelector": "g.simu g.s0 rect, g.simu g.s1 rect, g.simu g.s2 rect, g.simu g.s3 rect, g.simu g.s4 rect, g.simu g.s5 rect, g.simu g.s6 rect, g.simu g.s7 rect",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g.simu",
                            "confidence": "high",
                            "reason": "container group for all simulation mini-views and their legend"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g.simu g.s0 rect, g.simu g.s1 rect, g.simu g.s2 rect, g.simu g.s3 rect, g.simu g.s4 rect, g.simu g.s5 rect, g.simu g.s6 rect, g.simu g.s7 rect",
                            "confidence": "high",
                            "reason": "heatmap/time-bin rectangles within each simulation small multiple"
                        },
                        {
                            "selector": "g.simu g.s0 circle, g.simu g.s1 circle, g.simu g.s2 circle, g.simu g.s3 circle, g.simu g.s4 circle, g.simu g.s5 circle, g.simu g.s6 circle, g.simu g.s7 circle",
                            "confidence": "medium",
                            "reason": "simulation-level categorical markers (payable/nonpayable) encoded by circles"
                        },
                        {
                            "selector": "g.simu rect[fill=\"url(#balance)\"]",
                            "confidence": "high",
                            "reason": "net balance color scale swatch in simulation legend"
                        }
                    ]
                },
                "interaction": {
                    "candidates": [
                        {
                            "selector": "g.simu line.hover.h_line",
                            "confidence": "high",
                            "reason": "vertical hover lines inside each simulation mini-view"
                        },
                        {
                            "selector": "g.simu rect.hover.h_rect",
                            "confidence": "high",
                            "reason": "hover selection rectangle overlay in simulation mini-views"
                        }
                    ]
                }
            }
    ...
    {
        "step_id": "step_3",
        "text": "Each overview card shows per-call balance color bars by address and small circles for function types. Use it to compare activity across simulations.",
        "step_type": "data",
        "targets": {
            "target_view_id": "simulation_overview",
            "resolvedSelector": "g.simu g.s0 rect, g.simu g.s1 rect, g.simu g.s2 rect, g.simu g.s3 rect, g.simu g.s4 rect, g.simu g.s5 rect, g.simu g.s6 rect, g.simu g.s7 rect",
    ...
    {
        "step_id": "step_4",
        "text": "Within a card, each tiny rectangle encodes one call’s net balance for an address: pink is negative, blue is positive. A tan or beige colored dot marks payable vs nonpayable functions used.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "simulation_overview",
            "resolvedSelector": "g.simu g.s0 rect, g.simu g.s1 rect, g.simu g.s2 rect, g.simu g.s3 rect, g.simu g.s4 rect, g.simu g.s5 rect, g.simu g.s6 rect, g.simu g.s7 rect",
    ...
    {
        "step_id": "step_5",
        "text": "Click a card to load that simulation. The center timeline and the bottom state marks update to the selected run.",
    ...
    {
        "step_id": "step_6",
        "text": "Each function card summarizes one function: the colored square shows payable status, bars count calls and flows, and small triangle marks indicate money-in and money-out presence.",
        "step_type": "data",
        "targets": {
            "target_view_id": "function_overview",
            "resolvedSelector": "g.funcO rect",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g.funcO rect[fill=\"#b49b7f\" i]",
                            "confidence": "high",
                            "reason": "main function/address timeline group with labels and guides"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g.func text",
                            "confidence": "medium",
                            "reason": "function/address labels used for orientation"
                        },
                        {
                            "selector": "g.func line[stroke=\"#dee2e6\" i]",
                            "confidence": "high",
                            "reason": "guide/grid lines for function lanes"
                        },
                        {
                            "selector": "g.func line[stroke=\"#868e96\" i]",
                            "confidence": "medium",
                            "reason": "primary baseline lines (e.g., Contract axis) in the overview"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_7",
        "text": "Follow the short horizontal bars on a function card: the top bar counts calls, the middle bar counts money out, and the bottom bar counts money in for that function.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "function_overview",
            "resolvedSelector": "g.funcO rect",
    ...
    {
        "step_id": "step_8",
        "text": "Hover a function card to highlight its occurrences: faint linking curves and shaded rectangles point to the exact call columns in the timeline and state rows.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "function_overview",
            "resolvedSelector": "g.funcO rect",
    ...
    {
        "step_id": "step_9",
        "text": "Each narrow rectangle bar on a row marks a specific call by that address. Columns represent call order from left to right.",
        "step_type": "data",
        "targets": {
            "target_view_id": "function_timeline_calls",
            "resolvedSelector": "g.func rect[fill=\"#b49b7f\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g.func",
                            "confidence": "high",
                            "reason": "container holding the function call markers on the timeline"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g.func rect[fill=\"#b49b7f\" i]",
                            "confidence": "high",
                            "reason": "rectangles marking Payable function calls over time"
                        },
                        {
                            "selector": "g.func rect[fill=\"#dfceb4\" i]",
                            "confidence": "high",
                            "reason": "rectangles marking NonPayable function calls over time"
                        },
                        {
                            "selector": "g.func path[fill=\"black\" i]",
                            "confidence": "medium",
                            "reason": "small black triangular arrowheads indicating call direction markers"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_10",
        "text": "Look at each curved line with a triangle head: pink lines from a caller up to the contract mean money in; blue lines from the contract down mean payouts. Thicker lines mean larger value.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "function_timeline_flows",
            "resolvedSelector": "g.func path[stroke=\"#e1adc1\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g.func",
                            "confidence": "high",
                            "reason": "container of flow paths between function/address lanes"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g.func path[stroke=\"#e1adc1\" i]",
                            "confidence": "high",
                            "reason": "money-out flow paths (negative) connecting lanes"
                        },
                        {
                            "selector": "g.func path[stroke=\"#aab5d7\" i]",
                            "confidence": "high",
                            "reason": "money-in flow paths (positive) connecting lanes"
                        },
                        {
                            "selector": "g.func path[stroke-dasharray=\"3,2\"]",
                            "confidence": "medium",
                            "reason": "dashed transition/arcing guides within the function timeline"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_11",
        "text": "The softly filled shape on a row accumulates balance over time for that participant: pink areas indicate deficits, blue areas indicate gains.",
        "step_type": "data",
        "targets": {
            "target_view_id": "function_timeline_balances",
            "resolvedSelector": "g.func path[fill=\"#da99b1\" i][opacity]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g.func",
                            "confidence": "high",
                            "reason": "same container; filled areas encode balance over time"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g.func path[fill=\"#da99b1\" i][opacity]",
                            "confidence": "high",
                            "reason": "negative balance stacked/area paths"
                        },
                        {
                            "selector": "g.func path[fill=\"#aab5d7\" i][opacity]",
                            "confidence": "high",
                            "reason": "positive balance stacked/area paths"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_12",
        "text": "Each triangle mark shows the current address value of a variable (e.g., winner). An outlined triangle with a dashed link signals the value stayed the same across calls.",
        "step_type": "data",
        "targets": {
            "target_view_id": "state_timeline_values",
            "resolvedSelector": "g.state text",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g.state",
                            "confidence": "high",
                            "reason": "container group for state values timeline"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g.state rect.state[fill=\"#e3eae6\" i]",
                            "confidence": "high",
                            "reason": "state value boxes along the timeline"
                        },
                        {
                            "selector": "g.state text",
                            "confidence": "medium",
                            "reason": "numeric value labels rendered along the state timeline"
                        },
                        {
                            "selector": "g.state path.state[stroke-dasharray=\"3,2\"]",
                            "confidence": "medium",
                            "reason": "not-change connectors for state across time"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_13",
        "text": "For numerical variables, a single circle mark’s radius encodes magnitude; a blue border means increase, a pink border means decrease, and a gray-green border means unchanged.",
        "step_type": "encoding",
        "targets": {
            "target_view_id": "state_legend",
            "resolvedSelector": "g.legend circle.state",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g.legend",
                            "confidence": "high",
                            "reason": "legend group explaining state encodings"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g.legend circle.state",
                            "confidence": "high",
                            "reason": "legend circles for numerical and change categories"
                        },
                        {
                            "selector": "g.legend rect.state",
                            "confidence": "high",
                            "reason": "legend swatch for state value boxes"
                        },
                        {
                            "selector": "g.legend path.state",
                            "confidence": "high",
                            "reason": "legend triangles and dashed-line examples"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_14",
        "text": "Find columns where a winner triangle switches to a new address and the next blue curved line targets that same row. This pattern indicates a payout following winner selection.",
    ...
    {
        "step_id": "step_15",
        "text": "Scan for sequences of many pink inbound curves followed by a few thick blue outbound curves. This often reflects pooled deposits followed by concentrated payouts.",
        "step_type": "analytical",
        "targets": {
            "target_view_id": "function_timeline_balances",
            "resolvedSelector": "g.func path[fill=\"#da99b1\" i][opacity]",
    ...
    {
        "step_id": "step_16",
        "text": "Refer to the legend for color meanings: tan squares are payable, beige squares are nonpayable; pink denotes negative values, blue denotes positive values.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "function_legend",
            "resolvedSelector": "g.funcO rect[fill=\"#b49b7f\" i]",
            "raw": {
                "view": {
                    "candidates": [
                        {
                            "selector": "g.funcO",
                            "confidence": "high",
                            "reason": "legend group for function encodings"
                        }
                    ]
                },
                "encoding": {
                    "candidates": [
                        {
                            "selector": "g.funcO rect[fill=\"#b49b7f\" i]",
                            "confidence": "high",
                            "reason": "legend swatch for Payable Functions"
                        },
                        {
                            "selector": "g.funcO rect[fill=\"#dfceb4\" i]",
                            "confidence": "high",
                            "reason": "legend swatch for NonPayable Functions"
                        },
                        {
                            "selector": "g.funcO path[stroke=\"#e1adc1\" i]",
                            "confidence": "high",
                            "reason": "legend curves for Money Out (negative)"
                        },
                        {
                            "selector": "g.funcO path[stroke=\"#aab5d7\" i]",
                            "confidence": "high",
                            "reason": "legend curves for Money In (positive)"
                        },
                        {
                            "selector": "g.funcO rect[fill=\"#da99b1\" i]",
                            "confidence": "high",
                            "reason": "legend swatch for Negative balances"
                        },
                        {
                            "selector": "g.funcO rect[fill=\"#aab5d7\" i]",
                            "confidence": "high",
                            "reason": "legend swatch for Positive balances"
                        }
                    ]
                },
                "interaction": {
    ...
    {
        "step_id": "step_17",
        "text": "Focus on one call column: read the rectangle bar to identify the caller, follow any curved lines for money movement, then check the matching state triangle below.",
        "step_type": "interaction",
        "targets": {
            "target_view_id": "function_timeline_calls",
            "resolvedSelector": "g.func rect[fill=\"#b49b7f\" i]",
    ...
    {
        "step_id": "step_18",
        "text": "Recommended workflow: pick a simulation, inspect the function cards to choose a function, hover to spotlight its calls, then trace flows and confirm state changes in the aligned columns.",
        "step_type": "structure",
        "targets": {
            "target_view_id": "simulation_overview",
            "resolvedSelector": "g.simu g.s0 rect, g.simu g.s1 rect, g.simu g.s2 rect, g.simu g.s3 rect, g.simu g.s4 rect, g.simu g.s5 rect, g.simu g.s6 rect, g.simu g.s7 rect",
